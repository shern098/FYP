            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-white-600"> Tambah Pengurus </h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            <div>
                              ...
                              <form action="updataadmin.php" method="get">
                                <div class="col-md-7 col-sm-6 col-xs-12 form-group has-feedback">
                                    <input type="text" class="form-control" name="namaadmin" placeholder="Nama" required>
                                </div>
                                <div class="col-md-7 col-sm-6 col-xs-12 form-group has-feedback">
                                    <input type="text" class="form-control" name="jawadmin" placeholder="Jawatan" required>
                                </div>
                                <!-- button submit dan cancel -->
                                <div class="ln_solid"></div>
                                <div class="form-group">
                                    <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                                        <a href="AdminListAdmins.php">
