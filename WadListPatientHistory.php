              ...
              <div class="table-responsive">
                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    // select data
                    $getdata = "SELECT `masa_keyIn`, COUNT(*) AS total_patient  FROM tblpatient GROUP BY masa_keyIn;";
  ...
  <script>
    $(document).ready(function() {
      ...
      var table = $('#dataTable').DataTable({
        ...
        "info": false,
        searchPanes: {
          columns: [0, 1], // Specify the column indices to include in the search panes
