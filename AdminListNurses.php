                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Senarai Nurse</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        if (mysqli_num_rows($display) > 0) {
                                            ...
                                            while ($data = mysqli_fetch_assoc($display)) {
                                                ...
                                                <a onclick="return confirm('confirm delete?')"  <?php echo' href="AdminEditNurse.php?cmd=del&id='.$data['idnurse'].'"'?> class="btn btn-light btn-icon-split right">
                                                        <span class="icon text-white-600">
                                ...
                                <a href="AdminAddNurse.php" class="btn btn-light btn-icon-split right">
                                    <span class="icon text-white-600">
                                        <i class="fas fa-arrow-right"></i>
                                    </span>
                                    <span class="text">Tambah Nurse</span>
